...
@SessionScoped //a seÁ„o n„o some pois tem q guardar as compras j· feitas
public class CarrinhoBean implements Serializable {
	...
	public void finalizarCompra(){
		...
		//mostrar como n√£o usar isso, e usar inje√ß√£o de depend√™ncia
	...
	public String compraCartao(){
		...
		pedido.setPagamento(EnumTipoPagamento.CARTAO);
		
		System.out.println("Compra feita com cart√£o");
	...
	public String compraBoleto(){
		...
		pedido.setPagamento(EnumTipoPagamento.BOLETO);
